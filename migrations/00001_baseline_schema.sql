...
-- this migration establishes the baseline schema from the existing database.
-- it should be marked as applied on existing databases without running.
...
DROP TABLE IF EXISTS pub_requests;
DROP TABLE IF EXISTS fin_processes;
DROP TABLE IF EXISTS event_trackers;
DROP TABLE IF EXISTS event_participants;
DROP TABLE IF EXISTS event_heads;
DROP TABLE IF EXISTS event_files;
DROP TABLE IF EXISTS event_docu_head;
DROP TABLE IF EXISTS event_dates;
DROP TABLE IF EXISTS events;
DROP TABLE IF EXISTS api_keys;
ALTER TABLE members DROP CONSTRAINT IF EXISTS fk_committee;
DROP TABLE IF EXISTS committees;
DROP TABLE IF EXISTS divisions;
DROP TABLE IF EXISTS members;
DROP TABLE IF EXISTS terms;
DROP TABLE IF EXISTS pub_req_status;
DROP TABLE IF EXISTS progress_statuses;
DROP TABLE IF EXISTS fin_status;
DROP TABLE IF EXISTS fin_process_ref;
DROP TABLE IF EXISTS file_statuses;
DROP TABLE IF EXISTS event_types;
DROP TABLE IF EXISTS event_natures;
DROP TABLE IF EXISTS event_durations;
DROP TABLE IF EXISTS document_templates;
DROP TABLE IF EXISTS docu_status;
